...
class OrbitalEngine:
    ...
    def setup_board(self):
        # Centering the 8-piece sets in columns 4 through 11
        ...
        # 2. Main Piece Rank: One standard set per army (Rows 1 and 6)
        ...
        # 3. Inner Rank: Second row of 8 Pawns (Rows 2 and 5)
        for c in active_cols:
            self.board[2][c] = "bP"
            self.board[5][c] = "wP"
    ...
    def get_moves(self, r, c):
        ...
        # Directions for standard movement (Unrestricted)
        dirs = {
            'R': [(0,1), (0,-1), (1,0), (-1,0)],
            'B': [(1,1), (1,-1), (-1,1), (-1,-1)],
        ...
        if p_type in dirs:
            ...
            # Standard single step forward (No first-move restriction)
